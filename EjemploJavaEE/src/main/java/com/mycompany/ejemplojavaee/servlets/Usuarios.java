 ...
 */
package com.mycompany.ejemplojavaee.servlets;
...
public class Usuarios extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String cuenta = request.getParameter("sel_cuenta");
        ...
        try (PrintWriter out = response.getWriter()){
            ...
            out.println("<h1>Fecha de nacimiento " + fechaNacimiento + "</h1>");
            out.println("<h1>Contraseña " + password + "</h1>");
            out.println("<h1>Pseudonimo " + pseudonimo + "</h1>");
            out.println("<h1>Tipo de cuenta " + cuenta + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
